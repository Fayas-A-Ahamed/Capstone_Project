...
public class EventService{
    ...
    @Autowired
    public EventPlannerRepository eventPlannerRepository;


    public Event createEvent(Long plannerId, Event event){
        EventPlanner eventPlanner= eventPlannerRepository.findById(plannerId).orElseThrow(()-> new RuntimeException("Planner not found"));
    ...
    public Event updateEvent(Long eventId, Event eventDetails){
        Event event= eventRepository.findById(eventId).orElseThrow(()-> new RuntimeException("Event not found"));
            ...
            event.setFeedback(eventDetails.getFeedback());
            return eventRepository.save(event);
    }
    ...
    public Event updateFeedback(Long eventId, String feedback) {
        Event event = eventRepository.findById(eventId).orElseThrow(()-> new RuntimeException("Feedback not found"));
        event.setFeedback(feedback);
        return eventRepository.save(event);
    }
